...
/**
 * SGModel - Легковесная библиотека-класс для структурирования веб-приложений с помощью биндинг-моделей. Это упрощенный аналог Backbone.js! Библиотека хорошо адаптирована для наследования классов.
 * @english SGModel - Lightweight library for structuring web applications using binding models and custom events. This is a simplified version of Backbone.js! The library is well adapted for class inheritance.
 * @version 1.0.9
